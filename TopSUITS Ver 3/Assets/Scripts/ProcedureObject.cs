...
public class ProcedureObject {
    ...
    private string[,] disableAlarmProcedure()
    {
        string[,] temp = new string[,] { 
            ...
            {"Step 4:","On your belt, use the BLUE CARABINEER to securely tether to the TETHER CABLE inside the STORAGE.","CAUTION: Notice the TETHER CABLE is adjustable","disableAlarmDiagram4","disableAlarmAnimation4"},
            {"Step 5:","Locate the E-STOP button and gently press down to temporarily disable the alarm.","","disableAlarmDiagram5","disableAlarmAnimation5"},
            {"Step 6:","Locate the FUSIBLE DISCONNECT box and tether the BLUE CARABINEER to the TETHER CABLE.","","disableAlarmDiagram6","disableAlarmAnimation6"},
            {"Step 7:","Remove the BLUE CARABINEER from the FUSIBLE DISCONNECT box and transfer it to STORAGE.","","disableAlarmDiagram7","disableAlarmAnimation7"},
            {"Step 8:","Open the FUSIBLE DISCONNECT box and secure the lid in the open position.","CAUTION: Pull the locking tab toward STORAGE with the index finger while lifting the cover with the thumb.","disableAlarmDiagram8","disableAlarmAnimation8"},
            {"Step 9:","Locate the BLACK DISCONNECT and tether it to the TETHER CABLE.","","disableAlarmDiagram9","disableAlarmAnimation9"},
            {"Step 10:","Remove the DISCONNECT and place it in STORAGE.","CAUTION: Pull up with the index and middle fingers while pushing down on the FUSE ACCESS PANEL with the thumb.","disableAlarmDiagram10","disableAlarmAnimation10"},
            {"Step 11:","Tether the FUSE ACCESS PANEL to the TETHER CABLE.","","disableAlarmDiagram11","disableAlarmAnimation11"},
            {"Step 12:","Remove the FUSE ACCESS PANEL by pulling straight up.","","disableAlarmDiagram12","disableAlarmAnimation12"},
            {"Step 13:","Place the FUSE ACCESS PANEL into STORAGE.","","disableAlarmDiagram13","disableAlarmAnimation13"},
            {"Step 14:","Tether the ALARM FUSE to the TETHER CABLE.","","disableAlarmDiagram14","disableAlarmAnimation14"},
            {"Step 15:","In Storage, locate the BLUE FUSE PULLER.","","disableAlarmDiagram15","disableAlarmAnimation15"},
            {"Step 16:","Use the BLUE FUSE PULLER to remove ONLY the ALARM FUSE.","CAUTION: Rock the ALARM FUSE with the FUSE PULLER when pulling up.","disableAlarmDiagram16","disableAlarmAnimation16"},
            {"Step 17:","Return the ALARM FUSE and the FUSE PULLER to STORAGE.","","disableAlarmDiagram17","disableAlarmAnimation17"},
            {"Step 18:","In STORAGE, locate the FUSE ACCESS PANEL and reinstall it into the FUSIBLE DISCONNECT box.","","disableAlarmDiagram18","disableAlarmAnimation18"},
            {"Step 19:","Remove the FUSE ACCESS PANEL tether from the TETHER CABLE and stow inside.","WARNING: All tethers are under spring tension and can retract quickly.","disableAlarmDiagram19","disableAlarmAnimation19"},
            {"Step 20:","In STORAGE, locate the DISCONNECT and reinstall it into the FUSIBLE DISCONNECT box.","CAUTION: The DISCONNECT must read ON in the upper right corner to restore conductivity.","disableAlarmDiagram20","disableAlarmAnimation20"},
            {"Step 21:","Remove the DISCONNECT tether from the TETHER CABLE.","WARNING: All tethers are under spring tension and can retract quickly.","disableAlarmDiagram21","disableAlarmAnimation21"},
            {"Step 22:","Close the FUSIBLE DISCONNECT box cover.","","disableAlarmDiagram22","disableAlarmAnimation22"},
            {"Step 23:","In STORAGE, use the BLUE CARABINEER to clip and lock the FUSIBLE DISCONNECT box cover.","","disableAlarmDiagram23","disableAlarmAnimation23"},
            {"Step 24:","Remove the BLUE CARABINEER’s tether from the TETHER CABLE.","WARNING: All tethers are under spring tension and can retract quickly.","disableAlarmDiagram24","disableAlarmAnimation24"},
        };
        title = "Disable Alarm";
